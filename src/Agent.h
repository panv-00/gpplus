...
public:
  ...
  void set_pos   (Point pos  ) { this->pos.set_x(pos.get_x()); this->pos.set_y(pos.get_y()); };
  ...
  void set_hunger(int hunger ) { this->hunger = (hunger > HUNGER_MAX ? HUNGER_MAX : hunger); };
  void set_health(int health ) { this->health = (health > 0          ? health     : 0     ); };
